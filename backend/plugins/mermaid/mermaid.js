(function(){
  ...
  function getDataElem(slide) {
    ...
    var divs = Array.prototype.filter.call(children, function(element) { // spans to divs
      return element.nodeName === 'DIV'; // SPAN to DIV
    });
  ...
  function destroyDiagram(slide) {
    ...
    // so that it doesn't jump on screen
